...
var logger = NewLogger(LogConfig{})
...
func NewLogger(logConfig LogConfig) *Loggers {
	if logConfig.ENV == "" {
	...
	cfg.EncoderConfig.EncodeTime = hxTimeEncoder
	cfg.EncoderConfig.EncodeLevel = hxLevelEncoder
...
func hxTimeEncoder(t time.Time, enc zapcore.PrimitiveArrayEncoder) {
...
func hxLevelEncoder(l zapcore.Level, enc zapcore.PrimitiveArrayEncoder) {
